...
async function loginOnce(ctx) {
  ...
  if (page.url() === LOGIN_URL) {
    ...
    const $captchaError = "#ctl00_ctl00_contentPane_MainPanel_MainContent_ASPxCaptcha1_TB_EC";
    ...
    const $accountErr = "#ctl00_ctl00_contentPane_MainPanel_MainContent_FailureText";
